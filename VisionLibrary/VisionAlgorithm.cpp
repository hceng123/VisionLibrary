...
/*static*/ VisionStatus VisionAlgorithm::_inspBridgeItem(const cv::Mat &matGray, const cv::Mat &matResult, PR_INSP_BRIDGE_CMD::INSP_ITEM &inspItem, PR_INSP_BRIDGE_RPY::ITEM_RESULT &inspResult) {
